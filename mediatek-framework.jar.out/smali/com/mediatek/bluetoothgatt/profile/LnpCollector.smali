.class public Lcom/mediatek/bluetoothgatt/profile/LnpCollector;
.super Lcom/mediatek/bluetoothgatt/profile/ClientBase;
.source "LnpCollector.java"


# static fields
.field private static final DBG:Z = true

.field private static final TAG:Ljava/lang/String; = "LnpCollector"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 72
    const-string/jumbo v0, "LnpCollector"

    const-string/jumbo v1, "LnpCollector()"
...
.method public readBasBatteryLevel()Z
    ...
    .line 258
    invoke-virtual {p0, v0, v1}, Lcom/mediatek/bluetoothgatt/profile/LnpCollector;->readCharacteristic(Ljava/util/UUID;Ljava/util/UUID;)Z
...
.method public readBasBatteryLevelCccd()Z
    ...
    .line 355
    invoke-virtual {p0, v0, v1, v2}, Lcom/mediatek/bluetoothgatt/profile/LnpCollector;->readDescriptor(Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;)Z
...
.method public readLnsLnControlPointCccd()Z
    .locals 3
    ...
    const-string/jumbo v1, "readLnsLnControlPointCccd()"
    ...
    .line 309
    sget-object v1, Lcom/mediatek/bluetoothgatt/GattUuid;->CHAR_LN_CONTROL_POINT:Ljava/util/UUID;
...
.method public readLnsLnFeature()Z
    .locals 2
    ...
    const-string/jumbo v1, "readLnsLnFeature()"
    ...
    .line 95
    sget-object v1, Lcom/mediatek/bluetoothgatt/GattUuid;->CHAR_LN_FEATURE:Ljava/util/UUID;
...
.method public readLnsLocationAndSpeedCccd()Z
    .locals 3
    ...
    const-string/jumbo v1, "readLnsLocationAndSpeedCccd()"
    ...
    .line 293
    sget-object v1, Lcom/mediatek/bluetoothgatt/GattUuid;->CHAR_LOCATION_AND_SPEED:Ljava/util/UUID;
...
.method public readLnsNavigationCccd()Z
    .locals 3
    ...
    const-string/jumbo v1, "readLnsNavigationCccd()"
    ...
    .line 325
    sget-object v1, Lcom/mediatek/bluetoothgatt/GattUuid;->CHAR_NAVIGATION:Ljava/util/UUID;
...
.method public readLnsPositionQuality()Z
    .locals 2
    ...
    const-string/jumbo v1, "readLnsPositionQuality()"
    ...
    .line 110
    sget-object v1, Lcom/mediatek/bluetoothgatt/GattUuid;->CHAR_POSITION_QUALITY:Ljava/util/UUID;
...
.method public writeBasBatteryLevelCccd([B)Z
    ...
    .line 427
    invoke-virtual {p0, v0, v1, v2, p1}, Lcom/mediatek/bluetoothgatt/profile/LnpCollector;->writeDescriptor(Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;[B)Z
...
.method public writeLnsLnControlPoint(Lcom/mediatek/bluetoothgatt/characteristic/CharacteristicBase;)Z
    .locals 2
    ...
    const-string/jumbo v1, "writeLnsLnControlPoint()"
    ...
    .line 275
    invoke-virtual {p0, v0, p1}, Lcom/mediatek/bluetoothgatt/profile/LnpCollector;->writeCharacteristic(Ljava/util/UUID;Lcom/mediatek/bluetoothgatt/characteristic/CharacteristicBase;)Z
...
.method public writeLnsLnControlPointCccd([B)Z
    .locals 3
    .param p1, "value"    # [B
    ...
    const-string/jumbo v1, "writeLnsLnControlPointCccd()"
...
.method public writeLnsLocationAndSpeedCccd([B)Z
    .locals 3
    .param p1, "value"    # [B
    ...
    const-string/jumbo v1, "writeLnsLocationAndSpeedCccd()"
...
.method public writeLnsNavigationCccd([B)Z
    .locals 3
    .param p1, "value"    # [B
    ...
    const-string/jumbo v1, "writeLnsNavigationCccd()"

.class public Lcom/mediatek/bluetoothgatt/profile/CscpCollector;
.super Lcom/mediatek/bluetoothgatt/profile/ClientBase;
.source "CscpCollector.java"


# static fields
.field private static final DBG:Z = true

.field private static final TAG:Ljava/lang/String; = "CscpCollector"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 72
    const-string/jumbo v0, "CscpCollector"

    const-string/jumbo v1, "CscpCollector()"
...
.method public readCscsCscFeature()Z
    .locals 2
    ...
    const-string/jumbo v1, "readCscsCscFeature()"
    ...
    .line 95
    sget-object v1, Lcom/mediatek/bluetoothgatt/GattUuid;->CHAR_CSC_FEATURE:Ljava/util/UUID;

    .line 93
    invoke-virtual {p0, v0, v1}, Lcom/mediatek/bluetoothgatt/profile/CscpCollector;->readCharacteristic(Ljava/util/UUID;Ljava/util/UUID;)Z
...
.method public readCscsCscMeasurementCccd()Z
    .locals 3
    ...
    const-string/jumbo v1, "readCscsCscMeasurementCccd()"
    ...
    .line 276
    invoke-virtual {p0, v0, v1, v2}, Lcom/mediatek/bluetoothgatt/profile/CscpCollector;->readDescriptor(Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;)Z
...
.method public readCscsScControlPointCccd()Z
    .locals 3
    ...
    const-string/jumbo v1, "readCscsScControlPointCccd()"
...
.method public readCscsSensorLocation()Z
    .locals 2
    ...
    const-string/jumbo v1, "readCscsSensorLocation()"
...
.method public writeCscsCscMeasurementCccd([B)Z
    .locals 3
    .param p1, "value"    # [B
    ...
    const-string/jumbo v1, "writeCscsCscMeasurementCccd()"
    ...
    .line 310
    invoke-virtual {p0, v0, v1, v2, p1}, Lcom/mediatek/bluetoothgatt/profile/CscpCollector;->writeDescriptor(Ljava/util/UUID;Ljava/util/UUID;Ljava/util/UUID;[B)Z
...
.method public writeCscsScControlPoint(Lcom/mediatek/bluetoothgatt/characteristic/CharacteristicBase;)Z
    .locals 2
    ...
    const-string/jumbo v1, "writeCscsScControlPoint()"
    ...
    .line 260
    invoke-virtual {p0, v0, p1}, Lcom/mediatek/bluetoothgatt/profile/CscpCollector;->writeCharacteristic(Ljava/util/UUID;Lcom/mediatek/bluetoothgatt/characteristic/CharacteristicBase;)Z
...
.method public writeCscsScControlPointCccd([B)Z
    .locals 3
    .param p1, "value"    # [B
    ...
    const-string/jumbo v1, "writeCscsScControlPointCccd()"

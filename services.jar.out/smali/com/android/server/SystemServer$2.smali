...
.method constructor <init>(Lcom/android/server/SystemServer;Lcom/mediatek/mom/MobileManagerService;Landroid/content/Context;Lcom/android/server/NetworkScoreService;Lcom/android/server/NetworkManagementService;Lcom/android/server/net/NetworkStatsService;Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/ConnectivityService;Lcom/android/server/audio/AudioService;Lcom/android/server/wallpaper/WallpaperManagerService;Lcom/android/server/InputMethodManagerService;Lcom/android/server/statusbar/StatusBarManagerService;Lcom/android/server/LocationManagerService;Lcom/android/server/CountryDetectorService;Lcom/android/server/NetworkTimeUpdateService;Lcom/android/server/CommonTimeManagementService;Lcom/android/server/TextServicesManagerService;Lcom/android/server/AssetAtlasService;Lcom/android/server/input/InputManagerService;Lcom/android/server/TelephonyRegistry;Lcom/android/server/media/MediaRouterService;Lcom/android/server/MmsServiceBroker;Lcom/mediatek/perfservice/IPerfServiceManager;Lcom/mediatek/recovery/RecoveryManagerService;)V
    ...
    .param p10, "val$wallpaperF"    # Lcom/android/server/wallpaper/WallpaperManagerService;
    .param p11, "val$immF"    # Lcom/android/server/InputMethodManagerService;
    .param p12, "val$statusBarF"    # Lcom/android/server/statusbar/StatusBarManagerService;
    .param p13, "val$locationF"    # Lcom/android/server/LocationManagerService;
    .param p14, "val$countryDetectorF"    # Lcom/android/server/CountryDetectorService;
    .param p15, "val$networkTimeUpdaterF"    # Lcom/android/server/NetworkTimeUpdateService;
    .param p16, "val$commonTimeMgmtServiceF"    # Lcom/android/server/CommonTimeManagementService;
    .param p17, "val$textServiceManagerServiceF"    # Lcom/android/server/TextServicesManagerService;
    .param p18, "val$atlasF"    # Lcom/android/server/AssetAtlasService;
    .param p19, "val$inputManagerF"    # Lcom/android/server/input/InputManagerService;
    .param p20, "val$telephonyRegistryF"    # Lcom/android/server/TelephonyRegistry;
    .param p21, "val$mediaRouterF"    # Lcom/android/server/media/MediaRouterService;
    .param p22, "val$mmsServiceF"    # Lcom/android/server/MmsServiceBroker;
    .param p23, "val$perfServiceF"    # Lcom/mediatek/perfservice/IPerfServiceManager;
    .param p24, "val$recoveryF"    # Lcom/mediatek/recovery/RecoveryManagerService;

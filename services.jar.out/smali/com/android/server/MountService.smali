...
.method private isShowDefaultPathDialog(Landroid/os/storage/VolumeInfo;)Z
    ...
    const-string/jumbo v6, "isShowDefaultPathDialog, curVol="
    ...
    const-string/jumbo v5, "curVolume is null, skip it."
    ...
    .line 4032
    :cond_0
    sget-boolean v4, Lcom/android/server/MountService;->isBootingPhase:Z
    ...
    const-string/jumbo v5, "in booting phase, not show defaultPathDialog, skip it."
    ...
    .line 4037
    :cond_1
    sget-boolean v4, Lcom/android/server/MountService;->isIPOBooting:Z
    ...
    const-string/jumbo v5, "in IPO booting phase, not show defaultPathDialog, skip it."
    ...
    const-string/jumbo v5, "this volume state is not mounted/checking, skip it."
    ...
    .line 4048
    :cond_3
    iget-boolean v4, p0, Lcom/android/server/MountService;->isDiskInsert:Z
    ...
    const-string/jumbo v5, "not disk insert, no need show dialog, return false"
    ...
    .line 4053
    :cond_4
    iput-boolean v8, p0, Lcom/android/server/MountService;->isDiskInsert:Z
    ...
    const-string/jumbo v5, "PROP_VOLD_DECRYPT=trigger_restart_min_framework, return false"
    ...
    const-string/jumbo v5, "isShowDefaultPathDialog, emulated volume, return false"
    ...
    const-string/jumbo v7, "find a visibe & mounted volume, volumeId="
    ...
    const-string/jumbo v7, "mount and visible volumes count="
    ...
    const-string/jumbo v5, "isShowDefaultPathDialog, directly return false "

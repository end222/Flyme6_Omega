...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/nfc/cardemulation/AidGroup;
    ...
    .line 176
    :cond_0
    const-string/jumbo v8, "persist.cm885.nfc.feature"
    ...
    .line 185
    .end local v0    # "Aids":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v2    # "aid$iterator":Ljava/util/Iterator;
    .end local v5    # "description":Ljava/lang/String;
    .end local v7    # "mAidGroup":Landroid/nfc/cardemulation/AidGroup;
    :cond_2
    new-instance v8, Landroid/nfc/cardemulation/AidGroup;

    invoke-direct {v8, v3, v4}, Landroid/nfc/cardemulation/AidGroup;-><init>(Ljava/util/List;Ljava/lang/String;)V
